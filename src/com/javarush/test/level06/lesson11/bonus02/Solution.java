...
public class Solution
{
    ...
    public static class Cat
    {
        ...
        public String toString()
        {
            ...
            str.append("Cat name is ").append(name);
            if (mother == null) str.append(", no mother");
            else str.append(", mother is ").append(this.mother.name);


            if (father == null) str.append(", no father");
            else str.append(", father is ").append(this.father.name);
            return str.toString();
        }
